package com.mangal.lumiarychat.view.home
...
import com.mangal.lumiarychat.Constants
import com.mangal.lumiarychat.view.SingleMessage
import com.mangal.lumiarychat.ui.theme.Teal300
...
fun HomeView(
    ...
    Column(
        ...
        Button(
            onClick = { homeViewModel.logout(home = home) },
            modifier = Modifier
                .padding(16.dp)
                .fillMaxWidth(),
